...
export const defaultLeadership: Leader[] = [
  {
    id: "shivam-gupta",
    name: "Shivam Gupta",
    designation: "Founder & CEO, KADS LABS | Head, KADS TECHNOLOGIES",
    bio: "Founder and CEO of KADS LABS, driving the overall vision, innovation, and strategic growth across all divisions while leading KADS TECHNOLOGIES.",
    photo: "./team/shivam-gupta.jpg",
    skills: ["Strategic Leadership", "Product Vision", "Software Architecture", "AI Strategy", "Enterprise Growth"],
    social: {
