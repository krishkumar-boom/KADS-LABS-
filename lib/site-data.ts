...
export const defaultContent: SiteContent = {
  ...
  founderNote: "Leadership team driving innovation across KADS LABS, KADS MEDIA, and KADS TECHNOLOGIES.",
...
export const defaultLeadership: Leader[] = [
  {
    id: "shivam-gupta",
    name: "Shivam Gupta",
    designation: "Founder & Chief Executive Officer (CEO), KADS LABS · Chief Technology Officer (CTO), KADS TECHNOLOGIES",
    bio: "Founder & CEO of KADS LABS and CTO of KADS TECHNOLOGIES. Leads AI Development, SaaS Products, Enterprise Software, Mobile Apps, Web Applications, Product Strategy, Technical Consulting and Software Architecture across all divisions.",
    photo: "./team/shivam-gupta.jpg",
    skills: ["AI Development", "SaaS Products", "Enterprise Software", "Mobile Apps", "Web Applications", "Product Strategy", "Technical Consulting", "Software Architecture"],
    social: {
      linkedin: "https://www.linkedin.com/in/shivam-gupta-951112420?utm_source=share_via&utm_content=profile&utm_medium=member_android"
    },
    experience: [
      { company: "KADS LABS", role: "Founder & CEO", period: "2020 - Present", description: "Built KADS LABS from the ground up into a multi-division technology company, leading overall vision, AI strategy and enterprise engineering." },
      { company: "KADS TECHNOLOGIES", role: "Chief Technology Officer (CTO)", period: "2020 - Present", description: "Oversees technical delivery across web, mobile, AI, SaaS and cloud platforms." }
    ],
    order: 1,
    featured: true
  },
  {
    id: "ayush-jaiswal",
    name: "Ayush Jaiswal",
    designation: "Co-Founder & Director, KADS LABS · Chief Marketing Officer (CMO), KADS MEDIA",
    bio: "Co-Founder & Director of KADS LABS and CMO of KADS MEDIA, leading Social Media Strategy, Content Planning, Reels, Video Editing, Graphic Design, Branding, Creative Campaigns and Content Production.",
    photo: "./team/ayush-jaiswal.jpg",
    skills: ["Social Media Strategy", "Content Planning", "Reels Production", "Video Editing", "Graphic Design", "Branding", "Creative Campaigns", "Content Production"],
    social: {},
    experience: [
      { company: "KADS LABS", role: "Co-Founder & Director", period: "2020 - Present", description: "Co-leads the company vision and strategic direction of KADS LABS across divisions." },
      { company: "KADS MEDIA", role: "Chief Marketing Officer (CMO)", period: "2020 - Present", description: "Scaled KADS MEDIA into a full-service digital marketing & creative division serving global clients." }
    ],
    order: 2,
    featured: true
  },
  {
    ...
    designation: "Co-Founder & Director, KADS LABS · Chief Administrative Officer (CAO), KADS MEDIA",
    bio: "Co-Founder & Director of KADS LABS and Chief Administrative Officer (CAO) of KADS MEDIA, leading Operations, Administration, Advertisement Campaigns, Paid Advertising, Lead Generation, Client Acquisition, Campaign Management and Business Promotion.",
    photo: "./team/sudheer-maddheshiya.jpg",
    skills: ["Operations Management", "Administration", "Advertisement Campaigns", "Paid Advertising", "Lead Generation", "Client Acquisition", "Campaign Management", "Business Promotion"],
    social: {},
    experience: [
      { company: "KADS LABS", role: "Co-Founder & Director", period: "2020 - Present", description: "Co-leads company operations, administration and strategic growth at KADS LABS." },
      { company: "KADS MEDIA", role: "Chief Administrative Officer (CAO)", period: "2020 - Present", description: "Builds KADS MEDIA's operations, performance advertising and lead generation engine." }
    ],
    order: 3,
    featured: true
  }
...
export const defaultSocial: SocialLink[] = [
  { id: "social-facebook", platform: "Facebook", url: "https://facebook.com/kadslabs.ceo", icon: "Facebook", order: 1 },
  { id: "social-instagram", platform: "Instagram", url: "https://instagram.com/kadslabs", icon: "Instagram", order: 2 },
  { id: "social-twitter", platform: "X", url: "https://x.com/kadslabs", icon: "Twitter", order: 3 },
  { id: "social-linkedin", platform: "LinkedIn", url: "https://linkedin.com/in/kadslabs", icon: "Linkedin", order: 4 },
  { id: "social-youtube", platform: "YouTube", url: "https://youtube.com/@kadslabs", icon: "Youtube", order: 5 },
  { id: "social-threads", platform: "Threads", url: "https://www.threads.com/@kadslabs", icon: "Threads", order: 6 }
]
