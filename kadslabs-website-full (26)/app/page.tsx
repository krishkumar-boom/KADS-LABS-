...
import AzadiCampaign from "@/components/premium/AzadiCampaign"
import TechEcosystem from "@/components/premium/TechEcosystem"
  ...
  return (
    <ErrorBoundary>
      <main id="main-content" tabIndex={-1} className="relative min-h-screen outline-none" style={{ background: "var(--bg-primary)" }}>
        ...
        {/* ======== Azadi to Grow — Independence Day campaign (10–15 Aug) ======== */}
        <AzadiCampaign />
