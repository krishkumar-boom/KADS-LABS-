        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-[0.2em] mb-7 mx-auto lg:mx-0"
              style={{
                color: "#33B5FF",
            ...
            >
              <span className="relative flex h-1.5 w-1.5">
                ...
                <span className="relative inline-flex rounded-full h-1.5 w-1.5" style={{ background: "#33B5FF" }} />
              </span>
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl xl:text-[88px] font-bold tracking-[-0.04em] leading-[0.95] mb-5 text-balance"
              style={{ color: "var(--text-primary)", fontFamily: "'Space Grotesk', 'Inter', sans-serif" }}
            >
              Building Smarter<br />
              <span className="text-premium-gradient glow-text">Solutions.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl lg:text-2xl font-semibold mb-4 tracking-[-0.015em]"
              style={{
            ...
            <motion.p
              ...
              className="text-base sm:text-lg max-w-xl mx-auto lg:mx-0 mb-10 leading-[1.7]"
              style={{ color: "var(--text-muted)" }}
            >
              KADS LABS helps businesses transform ideas into powerful digital products
              with AI, Cloud, SaaS, and Modern Technologies.
            </motion.p>
            ...
            >
              <MagneticButton
                ...
                className="w-full sm:w-auto text-[0.95rem] px-7 justify-center"
              ...
              <MagneticButton
                ...
                variant="outline"
                className="w-full sm:w-auto text-[0.95rem] px-7 justify-center"
                ariaLabel="Watch Our Story"
              >
                <svg className="w-4 h-4 mr-1" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
                Watch Our Story
              </MagneticButton>
            </motion.div>
