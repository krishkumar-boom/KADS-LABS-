          ...
          {SERVICES.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="group premium-card cinematic-card relative overflow-hidden cursor-pointer"
              ...
              >
                ...
                <div aria-hidden="true"
                  ...
                  style={{
                    background: "radial-gradient(400px circle at var(--mx,50%) var(--my,50%), rgba(30,107,255,0.12), transparent 60%)"
                  }}
                />
