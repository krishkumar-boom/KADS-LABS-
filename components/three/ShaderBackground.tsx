...
export default function ShaderBackground({
  ...
  useEffect(() => {
    ...
    // Brand-aligned colors (0..1 space). Re-evaluated on resize so theme switch is picked up.
    const applyColors = () => {
      const isLight = document.documentElement.classList.contains("light")
      if (isLight) {
        // Lighter theme: softer blue on near-white bg
        gl.uniform3f(uC1, 0x1E / 255, 0x6B / 255, 0xFF / 255) // #1E6BFF
        gl.uniform3f(uC2, 0x0E / 255, 0xA5 / 255, 0xE9 / 255) // #0EA5E9
        gl.uniform3f(uC3, 0xFA / 255, 0xFB / 255, 0xFE / 255) // #FAFBFE
      } else {
        gl.uniform3f(uC1, 0x1E / 255, 0x6B / 255, 0xFF / 255) // #1E6BFF Electric
        gl.uniform3f(uC2, 0x33 / 255, 0xB5 / 255, 0xFF / 255) // #33B5FF Neon
        gl.uniform3f(uC3, 0x05 / 255, 0x07 / 255, 0x0B / 255) // #05070B black
      }
    }
    applyColors()
