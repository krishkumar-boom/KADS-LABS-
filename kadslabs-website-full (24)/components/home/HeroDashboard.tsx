 ...
 */
// Target bar heights (percentage of container height) - stable constant
const BAR_TARGETS = [42, 68, 52, 85, 60, 78, 48, 92]
...
export default function HeroDashboard({
  ...
  const [bars, setBars] = useState<number[]>(() => BAR_TARGETS.map(() => 6))
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setBars(BAR_TARGETS), 180)
