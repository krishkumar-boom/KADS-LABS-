...
import {
  Menu, X, User, LogOut, LayoutDashboard, UserCircle, ChevronDown, ChevronRight,
  BookOpen, Briefcase, BarChart3, Megaphone, Code2, Brain, Building2, Sparkles,
  Phone, ArrowRight, MessageSquare, Cpu, Cloud, Database, GraduationCap, Heart,
    ...
    columns: [
      {
        title: "Engineering",
        items: [
          { icon: Brain,      label: "AI Development",       href: "/services#ai", desc: "LLMs, agents, computer vision" },
          { icon: Code2,      label: "Custom Software",      href: "/services", desc: "Tailored to your workflows" },
          { icon: Sparkles,   label: "SaaS Development",     href: "/services#saas", desc: "Multi-tenant platforms" },
          { icon: Building2,  label: "Enterprise Systems",   href: "/services#enterprise", desc: "Mission-critical" },
        ],
      },
      {
        ...
        items: [
          ...
          { icon: Smartphone, label: "Mobile Apps",          href: "/services#mobile", desc: "iOS, Android, cross-platform" },
          { icon: Cpu,        label: "DevOps & SRE",         href: "/services#devops", desc: "CI/CD, observability" },
          { icon: Database,   label: "CRM & ERP",            href: "/services#crm", desc: "Line-of-business systems" },
        ],
      },
      {
        title: "Growth & Media",
        items: [
          ...
          { icon: BookOpen,   label: "Content Production",   href: "/services#content", desc: "Video, copy, creative" },
